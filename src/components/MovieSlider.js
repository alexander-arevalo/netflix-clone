...
// Create a context for managing visibility
const VisibilityContext = React.createContext();

const MovieSlider = ({ data, title }) => {
  const listRef = useRef();

  const themeContext = useContext(ThemeContext); // For accessing theme if needed
  ...
  return (
    <VisibilityContext.Provider value={controlVisibility}>
      <Container
